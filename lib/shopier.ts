...
export class Shopier {
  private paymentUrl: string = 'https://www.shopier.com/ShowProduct/api_pay4.php';
  ...
  private generateIForm(amount: number): IForm {
    const args: IForm = {
      ...
      product_type: this.buyer.product_type ?? ProductType.REAL_OBJECT,
    ...
    const platformOrderId = this.buyer.platform_order_id ?? this.buyer.buyer_id_nr;
